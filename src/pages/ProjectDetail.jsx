...
const allProjectsData = [
  {
    ...
    shortDescription:
      "AI-powered smart city solution integrating emergency-responsive traffic signals, real-time headcount tech for fire safety, and mobile apps for citizen feedback.",
    fullDescription: [
  ...
  },
  {
    ...
    shortDescription:
      "A centralized digital platform to streamline research activities, manage intellectual property rights, and support entrepreneurial growth.",
    fullDescription: [
  ...
  },
  {
    ...
    title: "Movie Website",
    shortDescription:
      "A dynamic movie platform built with React, fetching data from The Movie Database (TMDb) API.",
    fullDescription: [
    ...
    <div className="bg-black text-white min-h-screen font-sans pt-20">
      <nav className="w-full fixed top-0 left-0 z-50 bg-black bg-opacity-80 backdrop-blur-lg shadow-md">
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center text-white">
          ...
          <Link
            to="/#projects"
            className="text-sm md:text-base font-medium hover:text-gray-300 transition"
          >
            ← Back to Projects
          </Link>
        </div>
